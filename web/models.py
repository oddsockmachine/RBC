...
if __name__ == '__main__':
    ...
    with db_session:
        ...
        c9 = Component(uid='aaa', name='chive_soil_moist', description='chive soil moisture', kind='sensor', component_type='moisture', pin="1", nodule=N2)
        c10 = Component(uid='bbb', name='room lux', description='living room light intensity', kind='sensor', component_type='TSL2561', pin="i2c_2", nodule=N2)
        c11 = Component(uid='ccc', name='lamp', description='thai lamp', kind='actuator', component_type='relay', pin="3", nodule=N2)

        j7 = Job(uid='sss', name='chive_moist', description='Moisture of soil in chive pot', kind='sensor', interval='17',  tags='_', component=c9, nodule=N2)
        j8 = Job(uid='rrr', name='room light', description='Light intensity in living rom', kind='sensor', interval='30',  tags='_', component=c10, nodule=N2)
        j7 = Job(uid='qqq', name='room lamp', description='Turns on lamp in living room', kind='actuator', interval='100',  tags='_', component=c11, nodule=N2)
